...
// should not have after
pub const SAME_CHORD_SYMBOL_SHOULD_NOT_BE_PLACED_FIRST_OF_CHORD_BLOCK: &str =
    "Error: SameChordSymbol should not be placed first of ChordBlock";

// invalid
pub const INVALID_CHORD: &str = "Error: Invalid chord";
pub const INVALID_EXTENSION: &str = "Error: Invalid extension";
pub const EXTENSION_STRING_MUST_BE_SURROUNDED_BY_PARENTHESIS: &str =
    "Error: Extension string must be surrounded by parenthesis";
